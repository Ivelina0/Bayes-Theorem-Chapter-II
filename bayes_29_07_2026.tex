...
The Enigma machine transformed every typed letter by passing an electrical signal through a plugboard and a sequence of wired rotors before illuminating a ciphertext letter. Because the rotors moved as the machine was used, the substitution changed from one letter to the next. Knowledge of the machine itself was therefore insufficient: the cryptanalyst also needed to infer its unknown settings.
