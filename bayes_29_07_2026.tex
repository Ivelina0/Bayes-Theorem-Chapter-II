...
Jerzy Neyman (1894--1981) and Egon Pearson (1895--1980) developed another non-Bayesian answer. Their work between 1928 and 1933 treated testing as a choice between hypotheses and evaluated a procedure through its repeated performance: \textbf{Type I error}, \textbf{Type II error} and \textbf{power} \cite{neymanpearson1928,neymanpearson1933}.
...
Neyman's 1937 theory of \textbf{confidence intervals} extended the same repeated-sampling philosophy to estimation \cite{neyman1937}. Fisher and Neyman--Pearson are therefore often grouped together today, but their interpretations of statistical testing were not identical. Although Fisher and Neyman--Pearson are now commonly grouped under the broad label ‘frequentist’, their theories of testing differed substantially. Later textbooks on Statisitcs often combined Fisherian p-values/significance testing with Neyman–Pearson terminology and error-control machinery, despite disagreements between their founders
...
Jeffreys also returned to the old difficulty of choosing a prior. His 1939 book developed invariant approaches to prior choice, and his 1946 paper gave the general Fisher-information rule $\pi_J(\boldsymbol{\theta}) \propto \sqrt{\det I(\boldsymbol{\theta})},$ is invariant under smooth one-to-one reparameterisations \cite{jeffreys1939,jeffreys1946}.
