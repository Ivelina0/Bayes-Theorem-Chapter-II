...
% Bayesian research continues to develop rather than forming a finished theory.
% Recent work includes \textbf{robust and generalised Bayesian inference}; scalable methods for complex and high-dimensional models;
% Bayesian causal inference; and uncertainty quantification for modern machine
% learning and large language models. For readers interested in current work, the \href{https://bayesian.org/}{International Society for Bayesian Analysis (ISBA)} maintains conferences, workshops and specialist research communities, while its journal \emph{Bayesian Analysis} publishes current methodological and applied research. Active university groups include
% \href{https://www.ucl.ac.uk/mathematical-physical-sciences/statistics/research} {UCL Statistical Science} and the
% \href{https://bayescomp.kaust.edu.sa/} {Bayesian Computational Statistics and Modeling group at KAUST}, which develops scalable Bayesian methods including R-INLA, spatial and spatio-temporal models and approximate inference. KAUST also hosts a \href{https://stat.kaust.edu.sa/research-groups}{Bayesian Deep Learning group}, illustrating the continuing interaction between Bayesian inference, Gaussian processes and modern neural networks.
...
% \paragraph{Continuing debates and alternatives.}

% Bayesian inference nevertheless remains only one approach to learning from
% data. Questions surrounding the choice and interpretation of
% \textbf{prior distributions}, robustness to incorrect models and the
% computational cost of posterior inference continue to motivate both new
% Bayesian methods and alternative frameworks. Modern statistics and machine
% learning also draw on \textbf{statistical learning theory}, which studies
% generalisation from finite data; \textbf{conformal prediction}, which provides
% distribution-light guarantees on predictive uncertainty; causal inference;
% and optimisation-based approaches to learning. For further reading, see
% Vapnik's \emph{Statistical Learning Theory}, Vovk, Gammerman and Shafer's
% \emph{Algorithmic Learning in a Random World} for conformal prediction, and
% Boyd and Vandenberghe's \emph{Convex Optimization}. Current developments can
% also be followed through journals such as \emph{Bayesian Analysis} and the
% \emph{Journal of Machine Learning Research}. Thus, rather than replacing one
% another, Bayesian, frequentist and modern learning-based approaches continue
% to develop alongside one another, offering different ways of representing
% uncertainty, prediction and evidence.
